...
public class PermiActivity extends AppCompatActivity {
    ...
    private static final int INITIAL_REQUEST = 2016;
    ...
    private void bzzzt() {
        Toast.makeText(this, "toast_bzzzt", Toast.LENGTH_LONG).show();
    }

    private void doCameraThing() {
        Toast.makeText(this, "toast_camera", Toast.LENGTH_SHORT).show();
    }

    private void doContactsThing() {
        Toast.makeText(this, "toast_contacts", Toast.LENGTH_SHORT).show();
    }

    private void doLocationThing() {
        Toast.makeText(this, "toast_location", Toast.LENGTH_SHORT).show();
    }
}
